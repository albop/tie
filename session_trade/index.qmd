...
Tariff: the most beautiful word in the English language
- Trump
...
- threatened to implement some tariffs
- implemented some
- cancelled some too...
- and eventually implemented them

But why?

Commercial partners stand ready to retaliate
...
- The theory of absolute advantage (slides for reference),
- Ricardian analysis (slides for reference),
- The HOS model (slides for reference),
...
- International trade is a means to increase the inflow of precious metals into the Kingdom (UK).
...
Adam Smith (1723-1790): Scottish. One of the founding fathers of classical economics. His question: "Why do countries engage in international trade?"
...
Therefore, trade is profitable and each country specializes in the production of the good for which it has an absolute advantage.
...
Dans quel bien le Portugal doit-il se spécialiser ?
...
Avant le libre-échange, pour produire 2m de drap il fallait 190h de travail (100+90), et 200h de travail pour 2L de vin (120+80).

 Etant donnés les avantages comparatifs de chacun, le Portugal se spécialise dans le vin et l’Angleterre dans le drap. 

Pour produire les 2m de drap l’Angleterre va mettre 200h, économisant 20h par rapport à la situation précédente (cf. Tableau). Elle peut maintenant consacrer ces 20h supplémentaires à produire plus de drap par exemple.

Le Portugal abandonnant la production de drap, va mettre 160h pour produire les 2L de vin, il économise ainsi 10h de travail. Ainsi au total 30h de travail sont économisées (ou sont utilisées pour produire davantage de marchandises). Les deux pays bénéficient donc de la spécialisation et du libre-échange.

Ainsi, en raisonnant sur les coûts comparatifs et non absolus, il démontre (dans son cadre théorique) qu’il est avantageux pour chacun de se spécialiser dans la production pour laquelle il possède l’avantage le plus fort (vin portugais), ou le désavantage le plus faible (tissu anglais).
 La théorie ricardienne des avantages comparatifs lie le commerce international à des différences de technologie de production entre les pays (représentées par le nombre d’unités de travail nécessaires dans la production d’un bien dans un secteur donné). 
...
SMITH and absolute advantage: Trade is profitable, and each country specializes in the production of the good for which it has an absolute advantage.
But it does not explain why a country that is more efficient in the production of all goods would still benefit from maintaining trade relations with its neighboring countries.

RICARDO and comparative advantage: A country can benefit from specialization by producing the goods for which it has a comparative advantage, even if it has an absolute disadvantage in all the goods it produces.
But only labor factor (mobile within the country and immobile internationally).

HOS and factor endowments: In this model, international trade is based on differences in factor endowments (labor, capital, resources, etc.).
Partial specialization of each country in the good that is relatively the most intensive in the factor with which the country is relatively best endowed (better factor endowment).
Equalization of relative prices of goods between countries.

But the equalization of relative prices is rarely observed, even within a monetary union like the eurozone.
Assumes K and L are immobile internationally and totally mobile within the country between sectors.
...
This model allows for the consideration of intra-industry trade between countries with similar levels of development.
Why?
...
In 2003, Melitz introduced the notion of heterogeneous firms (in Krugman's model, firms are symmetrical, i.e., they all have the same production coefficients), heterogeneity which, within the same sector, will contribute to amplifying the gains from liberalization that economic literature had already identified:

Opening up to trade will indeed contribute to raising productivity, not only through economies of scale but also through a Darwinian process of firm selection.

Modern theoretical developments... to follow...
...
Could this explain trump policies?

## Various Tools

Many tools are available for trade policy:
...
## Reminder: Surplus in a Closed Economy
...
We assume a small country, importing a homogeneous good.
...
The State can also limit the purchase of foreign products by setting maximum quantities (or maximum values) for imports. This is called a quota or contingent.
...
States generally implement quota systems through licenses.
...
This measure is temporary, it will take effect on January 1, 2019, and is expected to be suspended at the end of 2020. The country being in a severe financial and economic crisis, this decree aims to restore budget balance.
...
Bilateral agreements? Recent US-Japan agreement (October 2019).

In Europe:
Politicization of trade and trade policy issues.
Question of European competence.
Difficulties encountered in ratifying CETA suggest that future EU participation in free trade agreements will be difficult.
Brexit.

## USA: New Deal

Since taking office in January 2017, President Trump has challenged some regional free trade agreements:
...
The Trump administration: a 58% increase in the number of anti-dumping and anti-subsidy measures between 2016 and 2017.
...
The safeguard measure announced in January 2018 against imports of washing machines and photovoltaic modules and panels is less usual in its procedure.
Not exceptional, however: already used in 2002 and 2009, in line with international agreements.

##

It is different for the two measures announced in March 2018:
...
In principle: provided for by the GATT (exception for national security reasons).
In form: contrary to commitments because purely political bases.
Measures especially exceptional by the amounts involved:
Measures on steel and aluminum initially targeted all partners, about $50 billion in imports (2017).
Then exemptions for certain countries (Australia, EU, South Korea, Canada, Mexico...).
So mainly targeting China.
