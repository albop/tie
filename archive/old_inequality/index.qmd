...
![](assets/inequalities_1.png){.fragment .current-visible fragment-index=1}

![](assets/inequalities_2.png){.fragment .current-visible fragment-index=2}
...
![](assets/income_inequality_1.png){.fragment .current-visible fragment-index=1 width=100%}

![](assets/income_inequality_3.png){.fragment .current-visible fragment-index=2 width=100%}

![](assets/gini.png){.fragment .current-visible fragment-index=3 width=100%}

![](assets/income_inequality_comparison.png){.fragment .fade-in fragment-index=4 width=100%}
...
- After-tax revenue for France in 2011:
...
- has it changed recenctly ?
  - check out the [World Inequality Ranking By Country 2022](https://www.statista.com/statistics/264627/ranking-of-the-20-countries-with-the-biggest-inequality-in-income-distribution/)
...
![](assets/global_distribution_1820.png){.fragment .current-visible}

![](assets/global_distribution_1910.png){.fragment .current-visible}

![](assets/global_distribution_1950.png){.fragment .current-visible}

![](assets/global_distribution_1980.png){.fragment .current-visible}

![](assets/global_distribution_2020.png){.fragment .current-visible}
...
- development has raised per capita income everywhere
- catchup effect is harder to measure
...
<small>From <u>Measuring and Comparing Consumption Inequality between France and the United States</u>, Aliocha Accardo, Sylvérie Herbert, Cristina Jude, Adrian Penalver
</small>
...
- Consumption Inequality is much lower than income inequality. Why?
-  Two main reasons
...
-  Do we actually want to reduce it?
...
- Modern version: Pareto weights $\omega_i$
...
- it is not clear what is the aversion to this kind of risk
  - Rawls/Knight: one maximizes utility in the worth case (<b>maximin criterion</b>)
- more redistribution than in the <em>utilitarian</em> case
...
- 💦: [Defending the One Percent](https://www.aeaweb.org/articles?id=10.1257/jep.27.3.21) in Journal of Economic Perspectives, 2013
...
![](assets/mankiw.png){.fragment .current-visible fragment-index=1 width="90%"}

![](assets/mankiw_devil.png){.fragment .current-visible fragment-index=2 width="90%"}
