...
![](assets/iccp_risk.png){height=100%}
...
## Carbon Budget {auto-animate="true"}
...
::::: incremental
- ↘ __population__ (growth)
    - a solution for developing countries
    - delicate issue...
- ↘ __production__ (growth)
...
::: {.notes}
We focus today on market solutions
:::
...
A stable global climate is a global public good[^common_good]
...
[^common_good]: On can also think of the  420Gt stock of remaining carbon emissions as a common good which is then subject to the *tragedy of commons*
...
This leads to the notion of __Pigouvian Taxation__: 
...
## Problems of the Carbon Tax {auto-animate="true"}
...
- it monetizes all activities
    ...
    - traditional answer: we need a metric to do cost-benefit analysis[^keynes]
- damage function does not correctly account for tail events (cf Weitzman)

[^keynes]: Keynes: *better to be vaguely right than precisely wrong*
...
##  More Integrated Assessment Models (1)
...
##  More Integrated Assessment Models (2)
...
![WEO/GMMET](assets/weo-ch3-chart-2.png)
