---
title: "Should we (Still) Fear the Return of the Big, Bad, Inflation?"
date: 2024/03/4
...
![CPI Inflation (Source IMF)](assets/inflation_short_horizon.png)

## Inflation {auto-animate="true"}
...
![CPI Inflation (Source IMF)](assets/inflation_long_horizon.png)
...
::: columns
:::: column
![World Inflation Outlook (2013)](assets/world_inflation_outlook_2013.png){width=200}
::::
:::: column
![World Inflation Outlook (2022)](assets/world_inflation_outlook_2022.png){width=200}
::::
:::
...
__Inflation is a 'wicked problem' − speech by Huw Pill, chief economist at Bank of England.__
...
::: columns
:::: column
![Keynesian Dog. (Dall E-2)](assets/keynesian_dog.png){width=50%}
::::
:::: column
![Ricardian Cat. (Dall E-2)](assets/ricardian_cat.png){width=50%}
::::
:::
...
![Inflation Inequality by Income Percentile: 2020->2022](assets/jaravel1.png)

::::

:::: {.fragment fragment-index=3 .current-visible}

![Inflation Inequality by Income Percentile: 2020->2022. Excluding Gas and Vehicles.](assets/jaravel2.png)
...
![Talks at Bocconi](assets/schnabel-page1.png)

::::
:::: column

![Isabel Schnabel](assets/isabel.jpg)
...
- What is really worrying is not __headline inflation__ (HICP) but __core inflation__
